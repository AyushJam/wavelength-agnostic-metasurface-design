...
def get_rt_nk(L1, L2, pthick, f, epgrid2, epgrid3, Nx, Ny):
  """
...
def save_spectrum_data(
  ...
  for f in spectrum:
    R, T, obj = get_rt_nk(L1, L2, pthick, f, epgrid2, epgrid3, Nx, Ny)
...
def plot_absorption_spectrum(spectrum_filename="spectrum.txt", abs_filename="absorption.txt", save_fig=True):
  """
